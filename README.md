...
| File                                                                                                                                                     | What it is      |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| [`noctty-1.3.131-windows-x64-setup.exe`](https://github.com/amanthanvi/noctty/releases/download/v1.3.131/noctty-1.3.131-windows-x64-setup.exe)           | x64 installer   |
| [`noctty-1.3.131-windows-arm64-setup.exe`](https://github.com/amanthanvi/noctty/releases/download/v1.3.131/noctty-1.3.131-windows-arm64-setup.exe)       | ARM64 installer |
| [`noctty-1.3.131-windows-x64-portable.zip`](https://github.com/amanthanvi/noctty/releases/download/v1.3.131/noctty-1.3.131-windows-x64-portable.zip)     | x64 portable    |
| [`noctty-1.3.131-windows-arm64-portable.zip`](https://github.com/amanthanvi/noctty/releases/download/v1.3.131/noctty-1.3.131-windows-arm64-portable.zip) | ARM64 portable  |

Each release also ships signed manifests of the portable ZIP contents
(`noctty-1.3.131-windows-x64-portable.manifest.ps1`,
`noctty-1.3.131-windows-arm64-portable.manifest.ps1`) and checksums
