...
const indexOnload = extractSingleMatch(indexHtml, onloadPattern, "site/index.html", "onload attribute");
const notFoundOnload = extractSingleMatch(notFoundHtml, onloadPattern, "site/404.html", "onload attribute");
