...
- Relationship to winghostty: winghostty is a hard fork; local `build.zig.zon` shows `version = "1.3.2-dev"`, i.e. the shared core is synced through the 1.3.1+ line (verified locally in /home/user/winghostty/build.zig.zon).
